<template>
  <div>
    ...
    <!-- 视图区 -->
    <el-card>
      <el-button type="danger" round>错题收藏</el-button>
      <el-card class="pageShowing">
        ...
        >
          <el-carousel-item
            v-for="(item, index) in collectedShowing"
            :key="item.id"
          >
        ...
        <div class="btns" v-if="collectedShowing != ''">
        ...
        <el-collapse accordion v-if="collectedShowing != ''">
